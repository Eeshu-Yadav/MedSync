...
const DoctorSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const response = await axios.post('http://127.0.0.1:8000/doctor/signup/', { mobile_number: mobileNumber, name });
  ...
  return (
    ...
    <div className=" py-32 ">
      ...
      <div className="max-w-md mx-auto p-6 space-y-4 border border-gray-400 rounded-lg shadow-sm">
        <h2 className="text-4xl py-4 font-semibold text-center">Sign Up</h2>
